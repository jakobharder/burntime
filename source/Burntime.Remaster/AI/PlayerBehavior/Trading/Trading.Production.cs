...
internal static partial class Trading
{
    ...
    internal static IEnumerable<ConstructionOpportunity> CompleteUsefulConstructionOpportunities(
        ClassicAiState state) => UsefulConstructionOpportunities(state)
            .Where(opportunity => opportunity.Materials.All(component =>
                HasConstructionComponent(state, component)));

    internal static bool HasCompleteUsefulRecipe(ClassicAiState state) =>
        CompleteUsefulConstructionOpportunities(state).Any();
    ...
    internal static bool CanUseCompleteRecipeAtCamp(ClassicAiState state, Location camp) =>
        CanUseCompleteRecipeAtCamp(
            state, camp, CompleteUsefulConstructionOpportunities(state));

    internal static bool CanUseCompleteRecipeAtCamp(
        ClassicAiState state,
        Location camp,
        IEnumerable<ConstructionOpportunity> completeOpportunities) =>
