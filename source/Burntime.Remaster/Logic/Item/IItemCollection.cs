...
/// </summary>
public interface IItemCollection : IEnumerable, IEnumerable<Item>
{
    /// <summary>
    /// Item count.
    /// </summary>
...
internal sealed class ItemCollectionEnumerator : IEnumerator, IEnumerator<Item>
{
    readonly IItemCollection _collection;
    int _current;
    ...
    public Item Current => _collection[_current];
}
#endregion
